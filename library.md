...
### 多版本价值主张
#### 20×20版本
- 有声版本投影片：在上方（文件）处，可下载查看，文件夹名称为【20×20价值主张】，里面包括一个PPT和20段录音。（如在PPT中听不到录音请在线观看PPT，网址如下）

- 在线观看PPT讲解价值主张网址：https://v.qq.com/x/page/d3049v7sya9.html

#### 一句话版本
- 提供最便利有效的预约占座与预约借阅书籍服务。
#### 一分钟版本
- 本产品的主要功能是预定座位和借阅书籍。用户首先进入初始页面，通过人脸识别或身份证识别进行身份认证后进入首页。在“首页”用户可进行座位预定和借阅书籍，操作简单方便；在“感应器”页面，用户可具体了解到感应器的作用及用法，结束学习后可进行签退；在“我的”页面，用户可查看自己的学习长度，违约次数和未签退次数，以供用户知道自己还有多少次数可用（违约或未签退次数到达一定数量会对用户惩罚）；用户亦可发表动态与其他用户分享。
...
#### 原型3.原型文档 
 ...
 [原型——展示](http://1198851307.gitee.io/library3)

 [原型——下载地址](https://github.com/NFUNM058/library1)

#### 原型4.口头操作说明 

- 本产品的主要功能是预定座位和借阅书籍。用户首先进入初始页面，通过人脸识别或身份证识别进行身份认证后进入首页。

- 在“首页”用户可进行座位预定和借阅书籍，操作简单方便；亦可以进入小店兑换物品或进入排行榜查看排行。

- 在“感应器”页面，用户可具体了解到感应器的作用及用法，结束学习后可进行签退。

- 在“我的”页面，用户可查看自己的学习长度，违约次数和未签退次数，以供用户知道自己还有多少次数可用（违约或未签退次数到达一定数量会对用户惩罚）；用户亦可发表动态与其他用户分享。
